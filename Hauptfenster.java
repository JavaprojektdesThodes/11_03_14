  ...
  */
  ...
  {        
    ...
    new ActionListener() {
        ...
        TextField eingabe_R1 = new TextField(+R1+"");
        TextField eingabe_R2 = new TextField(+R2+"");
        TextField ausgabe_Uout = new TextField(+Uout+"");
        Button berechnen = new Button("Berechnen");
        
        
        
                //eingabe_R1.setOpaque(false);
                //eingabe_R2.setOpaque(false);
                //ausgabe_Uout.setOpaque(false);
                
        
        
        eingabe_R1.setBounds(140,370,70,20);
        eingabe_R2.setBounds(140,390,70,20);
        ausgabe_Uout.setBounds(140,410,70,20);
        berechnen.setBounds(140,430,70,20);
      ...
      public void actionPerformed(ActionEvent event) {
        Frame hilfsFenster = new Frame("Hilfefenster") {
          public void paint(Graphics g) {
            ...
            g.drawString("Verwenden Sie bei Berechnungen mit Dezimalwerten den Punkt '.'", 10, 140);
            g.setColor(Color.black);
          }
        };
